<template>
    <div class="container-404">
        <div class="error"> <span>Page not found</span><span>404</span><span class="go-login" @click="logout({isShowMessage: false, immediate: true})">回到登录页</span>
        </div>
        <div class="sun"></div>
        <div class="clouds">
            <div></div>
...
<style lang="scss" scoped>
    ...
    .error {
        ...
        background-image: -webkit-linear-gradient(left, #2b758d, lightblue 25%, #2b758d 50%, lightblue 75%, #2b758d);
